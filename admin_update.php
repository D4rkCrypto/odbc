...
<nav class="top-bar" data-topbar role="navigation">
    ...
    <section class="top-bar-section">
        <ul class="left">
            <li><a href="admin_index.html">管理员主页</a></li>
            <li><a href="add_stu.html">添加学生</a></li>
            <li><a href="query_stu.html">查询学生</a></li>
            <li><a href="query_update.html">修改学生</a></li>
        </ul>
    </section>
</nav>
<header>
    <div class="row">
        <div class="large-12 columns">
            <h2>管理员修改学生</h2>
            <h4>对学生姓名，密码等进行更新操作</h4>
        </div>
    </div>
</header>
<div class="row">
    <form class="large-4 large-offset-4" action="admin_update_stu.php" method="post" enctype="multipart/form-data">
        <label>姓名</label>
        ...
        <br>
        <label>成绩</label>
        <input type="number" name="grades" min="0" max="100" value="<?php echo $item['grade'];?>" required="required">
        <label>备注</label>
